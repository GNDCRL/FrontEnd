...
namespace PeerLandingFE.Controllers.api
{
    public class ApiMstUserController : Controller
    {
        ...
        public async Task<IActionResult> GetUserById(string id)
        {
            ...
            var token = Request.Headers["Authorization"].ToString().Replace("Bearer ", "");
            _httpClient.DefaultRequestHeaders.Authorization = new AuthenticationHeaderValue("Bearer", token);
            var response = await _httpClient.GetAsync($"https://localhost:7020/rest/v1/user/GetUserId?userId={id}");
        ...
        public async Task<IActionResult> UpdateUser(string id, [FromBody] ReqMstUserDto reqMstUserDto)
        {
            ...
            var response = await _httpClient.PutAsync($"https://localhost:7020/rest/v1/user/UpdateUser/update/{id}", content);
        ...
        public async Task<IActionResult> DeleteUser(string id)
        {
            ...
            var response = await _httpClient.DeleteAsync($"https://localhost:7020/rest/v1/user/DeleteUser/delete/{id}");
        ...
        public async Task<IActionResult> RegisterUser([FromBody] ReqAddUserDto reqAddUserDto)
        {
            ...
            var response = await _httpClient.PostAsync($"https://localhost:7020/rest/v1/user/Register", content);
